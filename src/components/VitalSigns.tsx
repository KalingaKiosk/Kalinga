...
const fields: FieldConfig[] = [
  ...
  { key: 'spo2', label: 'SpO2 (Oxygen Saturation)', unit: '%', placeholder: '98', min: 50, max: 100, required: true, icon: '💉' },
  { key: 'heartRate', label: 'Pulse / Heart Rate', unit: 'bpm', placeholder: '72', min: 30, max: 220, required: true, icon: '❤️' },
  ...
  { key: 'respiratoryRate', label: 'Respiratory Rate', unit: '/min', placeholder: '16', min: 5, max: 60, icon: '🫁' },
  { key: 'weight', label: 'Weight', unit: 'kg', placeholder: '50', min: 10, max: 300, icon: '⚖️' },
];
